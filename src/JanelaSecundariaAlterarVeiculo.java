...
public class JanelaSecundariaAlterarVeiculo extends JFrame {
	...
	public JanelaSecundariaAlterarVeiculo(){
		super("Atualizar um veículo");
	    	...
	    	public void actionPerformed(ActionEvent e) {
				if(categoria.isEmpty() != true && num_passageiros != null && tamanho_bagageiro != null && tipo_cambio.isEmpty() != true && ar_condicionado != null && media_consumo != null && custo_dia != null) {
					if(num_passageiros <= 1 || num_passageiros > 50) {
						...
						JOptionPane.showMessageDialog(null, mensagem, "Atualização de um Veículo" ,JOptionPane.ERROR_MESSAGE);
					...
					if(freio_abs == null) {
						...
						try {
							...
							new VeiculosDAO().alterarVeiculo(novoVeiculo, idVeiculo);;
							mensagem = "Veículo atualizado com sucesso!\n";
							JOptionPane.showMessageDialog(null, mensagem, "Atualização de um Veículo", JOptionPane.INFORMATION_MESSAGE); // Deu certo
						}
						catch (NumeroForaDoIntervaloException e1){
							mensagem = "Houve um erro inesperado.";
							JOptionPane.showMessageDialog(null, mensagem, "Atualização de um Veículo", JOptionPane.ERROR_MESSAGE); // Algum erro inesperado
							e1.printStackTrace();
						}
					}
				}
	    ...
	    btnNewButton.setToolTipText("Atualiza as informações do veículo");
