...
public class JanelaAlterarClientes extends JFrame{
	...
	public JanelaAlterarClientes() {
		setTitle("Atualização de informações");
	    ...
	    panelBotoes.setBounds(0, 410, 706, 43);
	    getContentPane().add(panelBotoes);
	    panelBotoes.setLayout(null);
	    
	    JButton botaoCadastar = new JButton("ATUALIZAR");
	    	...
	    	public void actionPerformed(ActionEvent e) {
	    		...
	    		if(nome != null && nome.isEmpty() != true && idade != null && endereco.isEmpty() != true && carteiraCNH != null && cpf.isEmpty() != true) { // Verifico se há erro de memória ou algo assim
	    			if(nome.length() < 3) {
	    				...
	    				JOptionPane.showMessageDialog(null, mensagem, "Atualização de informações de clientes" ,JOptionPane.ERROR_MESSAGE);
	    				e1.printStackTrace();
	    			}
	    				...
	    				try {
	    					...
	    					new ClientesDAO().alterarClientes(novoCliente, idCliente); //Cadastro o cliente no banco de dados
	    					mensagem = "Cliente atualizado com sucesso!\n";
	    					JOptionPane.showMessageDialog(null, mensagem, "Atualização de informações de clientes" ,JOptionPane.INFORMATION_MESSAGE);
	    				}
	    			...
	    			mensagem = "Houve um erro inesperado.";
					JOptionPane.showMessageDialog(null, mensagem, "Atualização de informações de clientes", JOptionPane.ERROR_MESSAGE); // Algum erro inesperado
	    		}
	    	}
	    });
	    
	    
	    botaoCadastar.setToolTipText("Atualiza as informações do Cliente");
